...
# ====================================================
# Path to the file containing last 100 unique dates
...
for fecha in dates:      
    ...
    too_late_patito_negro= "20:30:00"  # Hora límite exigida para la formación del fractal patito negro para anular la entrada
    too_late_brake_fractal_pauta_plana = "21:00:00"  # Hora límite exigida para rotura del fractal patito negro para anular la entrada
