def pauta_plana_study(after_open_df, END_TIME, first_breakout_pauta_plana_time, y0_value, y1_value, patito_negro):
    """
    ...
    patito_to_min_points = patito_negro - min_value
